...
export const AddRestaurant = () => {
    ...
    const onCompleted = (data: createRestaurant) => {
        ...
        if(ok){
            ...
            setUploading(false);
            const queryResult = client.readQuery({query: MY_RESTAURANTS_QUERY}); //in the cache
            console.log(queryResult);
            client.writeQuery({query: MY_RESTAURANTS_QUERY,
            data: {
                myRestaurants: {
    ...
    const { register, getValues, formState, errors, handleSubmit } = useForm<IFormProps>({mode: "onChange"})
    ...
    const onSubmit = async () => {
        ...
        createRestaurantMutation({
            variables: {
                input: {
                    name, categoryName, address, coverImg
                }
            }
        })
